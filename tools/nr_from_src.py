    ...
    with tempfile.NamedTemporaryFile(mode="w+", suffix=".h") as f:
        with tempfile.TemporaryDirectory() as temp_include_dir:
            ...
            for fname in [
                ...
                with open("{}/asm/{}".format(temp_include_dir, fname), "w"):
                    pass
            os.symlink(
                "{}/include/asm-generic/rwonce.h".format(linux_path),
                "{}/asm/rwonce.h".format(temp_include_dir),
            )
            ...
            lines = subprocess.run(
                [
                    ...
                    "-nostdinc",
                    "-I",
                    "{}/arch/{}/boot".format(linux_path, arch),
                    "-I",
                    "{}/arch/{}/include".format(linux_path, arch),
                    "-I",
                    ...
                    "-I",
                    "{}/include/linux".format(linux_path),
                    "-I",
