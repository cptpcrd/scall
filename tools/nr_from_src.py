...
def main(args: List[str]) -> None:
    ...
    numbers = {
        "linux-aarch64": dict(load_headers(linux_path, names, "arm64")),
        "linux-armeabi": dict(
            list(
        ...
        "linux-sparc64": dict(load_headers(linux_path, names, "sparc")),
        "linux-x86": dict(
    ...
    for arch, nums in numbers.items():
        ...
        with open("{}/src/platform/{}/nr.rs".format(repo_path, arch), "w") as f:
