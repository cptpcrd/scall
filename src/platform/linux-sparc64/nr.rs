//! System call numbers for SPARC64 Linux.
...
pub const IO_PGETEVENTS: usize = 361;
...
pub const PKEY_ALLOC: usize = 363;
pub const PKEY_FREE: usize = 364;
pub const PKEY_MPROTECT: usize = 362;
