...
/* Automatically generated by bsd_nr_from_src.py */
...
pub const CSOPS_AUDITTOKEN: usize = 170;
pub const WAITID: usize = 173;
pub const KDEBUG_TYPEFILTER: usize = 177;
pub const KDEBUG_TRACE_STRING: usize = 178;
pub const KDEBUG_TRACE64: usize = 179;
...
pub const THREAD_SELFCOUNTS: usize = 186;
...
pub const OPEN_DPROTECTED_NP: usize = 216;
pub const FSGETPATH_EXT: usize = 217;
...
pub const SYSCTLBYNAME: usize = 274;
...
pub const LEDGER: usize = 373;
pub const KEVENT_QOS: usize = 374;
pub const KEVENT_ID: usize = 375;
...
pub const KAS_INFO: usize = 439;
pub const MEMORYSTATUS_CONTROL: usize = 440;
pub const GUARDED_OPEN_NP: usize = 441;
pub const GUARDED_CLOSE_NP: usize = 442;
pub const GUARDED_KQUEUE_NP: usize = 443;
pub const CHANGE_FDGUARD_NP: usize = 444;
pub const USRCTL: usize = 445;
pub const PROC_RLIMIT_CONTROL: usize = 446;
pub const CONNECTX: usize = 447;
pub const DISCONNECTX: usize = 448;
pub const PEELOFF: usize = 449;
pub const SOCKET_DELEGATE: usize = 450;
pub const TELEMETRY: usize = 451;
pub const PROC_UUID_POLICY: usize = 452;
pub const MEMORYSTATUS_GET_LEVEL: usize = 453;
pub const SYSTEM_OVERRIDE: usize = 454;
pub const VFS_PURGE: usize = 455;
pub const SFI_CTL: usize = 456;
pub const SFI_PIDCTL: usize = 457;
pub const COALITION: usize = 458;
pub const COALITION_INFO: usize = 459;
pub const NECP_MATCH_POLICY: usize = 460;
pub const GETATTRLISTBULK: usize = 461;
pub const CLONEFILEAT: usize = 462;
...
pub const GETATTRLISTAT: usize = 476;
pub const PROC_TRACE_LOG: usize = 477;
pub const BSDTHREAD_CTL: usize = 478;
pub const OPENBYID_NP: usize = 479;
pub const RECVMSG_X: usize = 480;
pub const SENDMSG_X: usize = 481;
pub const THREAD_SELFUSAGE: usize = 482;
pub const CSRCTL: usize = 483;
pub const GUARDED_OPEN_DPROTECTED_NP: usize = 484;
pub const GUARDED_WRITE_NP: usize = 485;
pub const GUARDED_PWRITE_NP: usize = 486;
pub const GUARDED_WRITEV_NP: usize = 487;
pub const RENAMEATX_NP: usize = 488;
pub const MREMAP_ENCRYPTED: usize = 489;
pub const NETAGENT_TRIGGER: usize = 490;
pub const STACK_SNAPSHOT_WITH_CONFIG: usize = 491;
pub const MICROSTACKSHOT: usize = 492;
pub const GRAB_PGO_DATA: usize = 493;
pub const PERSONA: usize = 494;
pub const MACH_EVENTLINK_SIGNAL: usize = 496;
pub const MACH_EVENTLINK_WAIT_UNTIL: usize = 497;
pub const MACH_EVENTLINK_SIGNAL_WAIT_UNTIL: usize = 498;
pub const WORK_INTERVAL_CTL: usize = 499;
pub const GETENTROPY: usize = 500;
pub const NECP_OPEN: usize = 501;
